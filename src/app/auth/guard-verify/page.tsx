      ...
      <div className="relative z-10 flex min-h-[100dvh] flex-col">
        ...
        <header className="flex items-center justify-between px-6 py-5 lg:px-10">
          <div className="flex items-center gap-4">
            <Link href="/" className="flex h-10 w-10 items-center justify-center rounded-lg border border-white/15 bg-white/10 text-white/60 transition-colors hover:bg-white/10 hover:text-white">
        ...
        <div className="flex flex-1 items-center justify-center px-6 pb-10 lg:px-10">
          <div className="w-full max-w-md">
            ...
            <h1 className="mt-5 text-center text-3xl font-extrabold tracking-tight text-white">
              Security Guard <span className="text-emerald-400">Sign-in</span>
            </h1>
