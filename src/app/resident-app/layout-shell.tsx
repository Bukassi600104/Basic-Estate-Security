  ...
  return (
    <div className="flex min-h-[100dvh] flex-col bg-[#0a1a0f]">
      ...
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-40 -right-40 h-80 w-80 rounded-full bg-brand-green/5 blur-[100px] animate-pulse-soft" />
        <div className="absolute -bottom-40 -left-40 h-80 w-80 rounded-full bg-brand-green/8 blur-[100px] animate-pulse-soft" style={{ animationDelay: "1s" }} />
      </div>
          ...
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                ...
                {tab.label}
                {active && (
                  <div className="mt-0.5 h-1 w-1 rounded-full bg-brand-green" />
                )}
              </Link>
            );
          })}
