...
function CheckoutPageContent() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      ...
      <h1 className="text-2xl font-bold text-white">Complete Your Upgrade</h1>
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <div className="mt-6 flex items-start gap-4 rounded-xl bg-white/5 p-4">
            ...
            <div className="flex-1">
              <h3 className="font-bold text-white">{tierConfig.name} Plan</h3>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <div className="mt-6 rounded-xl border-2 border-dashed border-white/10 bg-white/5 p-8 text-center">
