      ...
      <div className="mb-8 flex items-start justify-between">
        ...
        {canAddMore ? (
          ...
          <div className="text-right">
            <span className="inline-flex items-center gap-1 rounded-full bg-white/10 px-3 py-1.5 text-xs font-semibold text-white/60">
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-center gap-2">
                  <Link
                    ...
                    className="rounded-lg p-2 text-white/40 hover:bg-white/10 hover:text-white/60"
                  ...
                  <button
                    ...
                    className="rounded-lg p-2 text-white/40 hover:bg-rose-500/150/10 hover:text-rose-400"
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                {(!admin.permissions || admin.permissions.length === 0) && (
                  <span className="text-xs text-white/40">No permissions assigned</span>
                )}
              </div>
            </div>
          ))}
